                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/'.$image_name.'" width="150px">'; 
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != "")
        {
            ...
            if($upload == false) 
            {
                ...
                header('location: update-Fproduct.php'); die();
            }

            if($current_image != "") 
            { 
                $remove_path = "../Images/Featured Products/".$current_image; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
                    header('location: update-Fproduct.php'); 
                    die(); 
                } 
            }
        }
