    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                <tr>
                    <td>Title: </td>
                    <td><input type="text" name="title" placeholder="Arrival Title"></td>
                </tr>
                <tr>
                    <td>Select Image: </td>
                    <td>
                ...
                <tr>
                    <td>Description: </td>
                    <td>
                        <textarea name="description" placeholder="Arrival Description" cols="22" rows="4"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Arrival" class="primary-btn">
                    </td>
                </tr>
            </table>
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($_FILES['image']['name']))
        {
            ...
            if($upload==false)
            {
                ...
                header('location: add-arrival.php');
        ...
        //Save Data
        $sql = "INSERT INTO new_arrivals SET
            title = '$title',
        ...
        if($res==TRUE){
            $_SESSION['add'] = "<div class='success'>New Arrival Added Successfully</div>";

            header("location: new-arrival.php");
        }
        else{
            $SESSION['add'] = "<div class='error'>❌Failed to Add New Arrival. Try Again Later!!</div>";
