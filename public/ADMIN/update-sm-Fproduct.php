<?php include('partials/menu.php'); ?>
    ...
    <div class="main-content">
        <div class="wrapper">
            <h1>Update Small Featured Product</h1>
            <br>
            <br>
            ...
            <?php 
                ...
                //Get Details
                $sql = "SELECT *FROM sm_feat_products WHERE id='$id'";
            ...
            <table class="tbl-30"> 
                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/Small Products/'.$color1.'" width="150px">'; 
                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/Small Products/'.$color2.'" width="150px">'; 
                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/Small Products/'.$color3.'" width="150px">'; 
                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/Small Products/'.$color4.'" width="150px">'; 
                    ...
                    <td> 
                        <?php 
                            ...
                            { 
                                ...
                                echo '<img src="../Images/Featured Products/Small Products/'.$color5.'" width="150px">'; 
                ...
                <tr>
                    <td colspan="2">
                            ...
                            <input type="submit" name="submit" value="Update Featured" class="secondary-btn">
                        </td>
                </tr>
            </table>
            </form>
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(isset($_FILES['image1']['name']) && $_FILES['image1']['name'] != "")
        {
            ...
            $color1 = "Sm_Featured_Product_".rand(000, 999).'.'.$ext; 

            $source_path = $_FILES['image1']['tmp_name']; 
            $destination_path = "../Images/Featured Products/Small Products/".$color1; 

            $upload = move_uploaded_file($source_path, $destination_path); 
            if($upload == false) 
            {
                $_SESSION['upload'] = "<div class='error'>Failed to upload image❌</div>"; 
                header('location: update-sm-Fproduct.php'); die();
            }

            if($current_image1 != "") 
            { 
                $remove_path = "../Images/Featured Products/Small Products/".$current_image1; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
                    header('location: update-sm-Fproduct.php'); 
                    die(); 
                } 
            }
        }
        ...
        if(isset($_FILES['image2']['name']) && $_FILES['image2']['name'] != "")
        {
            ...
            $color2 = "Sm_Featured_Product_".rand(000, 999).'.'.$ext; 

            $source_path = $_FILES['image2']['tmp_name']; 
            $destination_path = "../Images/Featured Products/Small Products/".$color2; 
            ...
            if($current_image2 != "") 
            { 
                $remove_path = "../Images/Featured Products/Small Products/".$current_image2; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
        ...
        if(isset($_FILES['image3']['name']) && $_FILES['image3']['name'] != "")
        {
            ...
            $color3 = "Sm_Featured_Product_".rand(000, 999).'.'.$ext; 

            $source_path = $_FILES['image3']['tmp_name']; 
            $destination_path = "../Images/Featured Products/Small Products/".$color3; 
            ...
            if($current_image3 != "") 
            { 
                $remove_path = "../Images/Featured Products/Small Products/".$current_image3; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
        ...
        if(isset($_FILES['image4']['name']) && $_FILES['image4']['name'] != "")
        {
            ...
            $color4 = "Sm_Featured_Product_".rand(000, 999).'.'.$ext; 

            $source_path = $_FILES['image4']['tmp_name']; 
            $destination_path = "../Images/Featured Products/Small Products/".$color4; 
            ...
            if($current_image4 != "") 
            { 
                $remove_path = "../Images/Featured Products/Small Products/".$current_image4; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
        ...
        if(isset($_FILES['image5']['name']) && $_FILES['image5']['name'] != "")
        {
            ...
            $color5 = "Sm_Featured_Product_".rand(000, 999).'.'.$ext; 

            $source_path = $_FILES['image5']['tmp_name']; 
            $destination_path = "../Images/Featured Products/Small Products/".$color5; 
            ...
            if($current_image5 != "") 
            { 
                $remove_path = "../Images/Featured Products/Small Products/".$current_image5; 
                $remove = unlink($remove_path); 
                if($remove == false) 
                { 
                    $_SESSION['remove-failed'] = "<div class='error'>Failed to remove current image❌</div>"; 
        ...
        //Update Category
        $sql = "UPDATE sm_feat_products SET
        title = '$title',
        color1 = '$color1', 
        color2 = '$color2',
        color3 = '$color3',
