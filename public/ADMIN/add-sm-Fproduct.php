            ...
            <table class="tbl-30">
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        $sql2 = "SELECT * from featured_products";
                        ...
                        if($res2) {
                            ...
                            echo "<option value='0'>No Featured Product Found</option>";
                        }
                        ?>
                        </select>
                    </td>
...
<?php 
    if(isset($_POST['submit'])){
        ...
        if(isset($_FILES['image1']['name']))
        {
            ...
            $color1 = "sm_Feat_Product_".rand(000, 999).'.'.$ext;
            ...
            if($upload==false)
            {
                ...
                header('location: add-sm-Fproduct.php');
        ...
        if(isset($_FILES['image2']['name']))
        {
            ...
            $color2 = "sm_Feat_Product_".rand(000, 999).'.'.$ext;
        ...
        if(isset($_FILES['image3']['name']))
        {
            ...
            //Rename the image eg. Food_Category_123.jpg
            $color3 = "sm_Feat_Product_".rand(000, 999).'.'.$ext;
        ...
        if(isset($_FILES['image5']['name']))
        {
            ...
            //Rename the image eg. Food_Category_123.jpg
            $color5 = "sm_Feat_Product_".rand(000, 999).'.'.$ext;
        ...
        //Save Data
        $sql = "INSERT INTO sm_feat_products SET
            title = '$title',
            color1 = '$color1',
            color2 = '$color2',
            color3 = '$color3',
